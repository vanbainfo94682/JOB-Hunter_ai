          ...
          <div className="nav-actions" style={{ display: 'flex', alignItems: 'center', gap: '10px', marginLeft: '20px' }}>
            {currentUser ? (
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <button onClick={() => setActiveTab('settings')} className={`nav-btn ${activeTab === 'settings' ? 'nav-btn-active' : ''}`}>
                  <Settings2 style={{ width: '14px', height: '14px' }} /> Settings
                </button>
                <button onClick={() => setActiveTab('logs')} className={`nav-btn ${activeTab === 'logs' ? 'nav-btn-active' : ''}`}>
                  <Activity style={{ width: '14px', height: '14px' }} /> Logs
                </button>
