...
const CATEGORIZED_ROLES = {
  "Software Engineering": [
    "Frontend Developer", "Backend Developer", "Full Stack Engineer", "Web Developer",
    "Mobile Developer (iOS / Android)", "iOS Developer", "Android Developer", "React Native Developer",
    "Game Developer", "Embedded Systems Engineer", "C++ Developer", "Java Developer", "Python Developer",
    "Golang Developer", "Rust Developer", "PHP Developer", "Ruby on Rails Developer", "Node.js Developer"
  ],
  "Architecture & Infrastructure": [
    "Systems Architect", "Cloud Architect / Engineer", "DevOps / SRE", "Platform Engineer",
    "Database Administrator", "Network Engineer", "Systems Administrator", "Hardware Engineer",
    "Site Reliability Engineer (SRE)"
  ],
  "Data & AI": [
    "Data Science / AI / ML", "Data Engineer", "Data Analyst", "Machine Learning Engineer",
    "AI Prompt Engineer", "Computer Vision Engineer", "NLP Engineer", "Big Data Engineer",
    "Bioinformatics Specialist"
  ],
  "Design & Product": [
    "UI/UX Designer", "Product Designer", "Graphic Designer / Illustrator", "Motion Designer",
    "Product Manager", "Product Owner", "UX Researcher", "Technical Writer"
  ],
  "Security & Quality": [
    "Cyber Security Specialist / Analyst", "Security Engineer", "Penetration Tester",
    "QA / Test Engineer", "Automation Engineer", "SDET"
  ],
  "Enterprise & Consulting": [
    "Salesforce / CRM Developer", "SAP Consultant / Engineer", "ServiceNow Developer",
    "Business Analyst", "Scrum Master / Agile Coach", "Project Manager"
  ],
  "Management & Leadership": [
    "Engineering Manager", "Tech Lead", "CTO / VP of Engineering", "Chief Executive Officer (CEO)"
  ],
  "Business & Operations": [
    "Marketing Manager / Specialist", "SEO & Content Specialist", "Growth Hacker",
    "Sales Development / Account Executive", "Sales Engineer", "Business Development Manager",
    "HR Specialist / Recruiter", "Talent Acquisition", "People Operations Manager",
    "Customer Success Manager", "Customer Support Specialist", "Technical Support Engineer",
    "Operations Manager", "Finance / Data Analyst"
  ]
};
                  ...
                  <button 
                    ...
                    onClick={async () => {
                      if (token) {
                        ...
                        setJobs([]); // Clear to show visual refresh
                        await fetchJobs(token);
                        setToastMessage('✅ Feed refreshed successfully!');
                        setTimeout(() => setToastMessage(null), 3000);
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                <thead style={{ background: 'rgba(0,0,0,0.2)' }}>
                  <tr>
                    ...
                    <th style={{ padding: '16px', color: 'var(--text-secondary)', fontSize: '0.75rem', textTransform: 'uppercase' }}>HR Contact Name</th>
                    ...
                    jobs.filter(j => j.hrEmailSent).sort((a,b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).map(job => (
                      <tr key={job.id} style={{ borderTop: '1px solid var(--border-color)' }}>
                        ...
                        <td style={{ padding: '16px', color: 'var(--text-secondary)', fontSize: '0.85rem' }}>
                          <span style={{ color: 'white' }}>{job.hrName || 'Unknown'}</span>
                          <br />
                          <span style={{ fontSize: '0.7rem' }}>{job.hrTitle || 'HR Representative'}</span>
                        </td>
                ...
                <div className="form-group">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', marginTop: '8px' }}>
                    {Object.entries(CATEGORIZED_ROLES).map(([category, roles]) => (
                      <div key={category}>
                        <div style={{ fontSize: '0.75rem', fontWeight: 'bold', color: 'var(--primary)', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>{category}</div>
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                          {roles.map(f => {
